...
# Ringtone Paths.
ringtones_path = {
    'mom_calling': 'Alarm_Clock/Ringtones/mom_calling.mp3',
    'nice_wake_up': 'Alarm_Clock/Ringtones/nice_wake_up.mp3',
    'romantic': 'Alarm_Clock/Ringtones/romantic.mp3',
    'twirling_intime': 'Alarm_Clock/Ringtones/twirling_intime.mp3',
    'wakeup_alarm_tone': 'Alarm_Clock/Ringtones/wakeup_alarm_tone.mp3'
}
class Alarm_Clock:
    ...
    def __init__(self, root):
        ...
        self.window.title("Alram Clock")
        
        # Background image of the first window.
        self.bg_image = ImageTk.PhotoImage(file="Alarm_Clock/Images/image_1.jpeg")
...
# in the another window for setting alarm time.
    def set_alarm_time(self):
        ...
        try:
            ...
            messagebox.showerror("Error!", f"Error due to {est}")
